...
const main = {
    ...
    endpoints: {
        ...
        cdn: "<?= $mcfg->platform->endpoints->cdn ?>"
    },
    lang: "en",
    api: {
    ...
    __meta: {
        ...
        origin: <?= json_encode(['data' => (isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : (isset($_SERVER['HTTP_ORIGIN']) ? $_SERVER['HTTP_ORIGIN'] : null))]) ?>
    },
